<template>
   <div class="card grid lg:grid-cols-4 md:grid-cols-2 lg:gap-8 md:gap-4">
      <div
         ...
         <router-link
            :to="`/tv/${movie.id}`"
            class="px-4 py-1 bg-pink-600 block shadow-sm rounded-full text-center my-3 hover:text-white hover:bg-white/70 backdrop-blur-md">
            Detail
         </router-link>
      </div>
   </div>
